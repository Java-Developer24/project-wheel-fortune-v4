              ...
              <table className="min-w-full">
                <thead className="bg-gray-100 sticky top-0 z-10">
                  <tr>
                    ...
                    <th className="py-3 px-4 text-center text-sm font-semibold text-gray-700">Tier</th>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-3 px-4 text-center">
                          <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-gradient-to-r ${getBadgeColor(guide.bucket)} text-white`}>
                            {guide.bucket.charAt(0).toUpperCase() + guide.bucket.slice(1)}
                          </span>
                        </td>
                        <td className="py-3 px-4 text-center">
