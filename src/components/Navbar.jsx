            ...
            <div className="relative flex h-18 items-center justify-between">
              ...
              <div className="flex flex-2 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <img
                   ...
                   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRW9CbUwvIYNcGGoRrkkRl6N4fRpK_E71GGfw&s"
                    alt="Genpact"
                  />
                  <b className='h-auto w-auto'>|</b>
                  <img
                    className="h-24 w-auto rounded p-2"
                   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTOIA_g9Uk-c1GO5Ho6prO4ZAYwDsJM6XSlMQ&s" 
                    alt="GoDaddy"
                  />
